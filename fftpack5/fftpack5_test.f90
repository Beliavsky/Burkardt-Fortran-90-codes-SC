...
!*****************************************************************************80
!
!! MAIN is the main program for FFTPACK5_TEST.
!
!  Discussion:
!
!    FFTPACK5_TEST tests the FFTPACK5 library.
!
!  Licensing:
!
...
!
  ...
  call c4mat_print_some ( l, m, c, 1, 1, 5, 5, '  Part of the original data:' )
!
!  Compute the FFT coefficients.
!
  ldim = l
...
!
  ...
  call c4mat_print_some ( n, lot, c, 1, 1, 5, 5, '  Part of the original data:' )
!
!  Compute the FFT coefficients.
!
  jump = n
...
!*****************************************************************************80
!
!! TEST075 tests DCOSQ1B, DCOSQ1F and DCOSQ1I.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  integer ( kind = 4 ), parameter :: lenwrk = n
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST075'
  write ( *, '(a)' ) '  For real double precision fast cosine transform, 1D,'
  write ( *, '(a)' ) '  DCOSQ1I initializes the transform,'
  write ( *, '(a)' ) '  DCOSQ1F does a forward transform;'
  write ( *, '(a)' ) '  DCOSQ1B does a backward transform.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,i8)' ) '  The number of data items is N = ', n
!
!  Set work arrays.
!
  lensav = 2 * n + int ( log ( real ( n, kind = 4 ) ) ) + 4

  allocate ( wsave(1:lensav) )

  call dcosq1i ( n, wsave, lensav, ier )
!
!  Set the data values.
!
  seed = 1973
...
!
  ...
  call dcosq1f ( n, inc, r, lenr, wsave, lensav, work, lenwrk, ier )
...
!  original data.
!
  call dcosq1b ( n, inc, r, lenr, wsave, lensav, work, lenwrk, ier )
...
!*****************************************************************************80
!
!! TEST08 tests DFFT1B, DFFT1F and DFFT1I.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST08'
  write ( *, '(a)' ) '  For real double precision fast Fourier transform, 1D,'
  write ( *, '(a)' ) '  DFFT1I initializes the transform,'
  write ( *, '(a)' ) '  DFFT1F does a forward transform;'
  write ( *, '(a)' ) '  DFFT1B does a backward transform.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,i8)' ) '  The number of data items is N = ', n
!
!  Set work vectors.
...
!  original data.
!
  call dfft1b ( n, inc, r, lenr, wsave, lensav, work, lenwrk, ier )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST09'
  write ( *, '(a)' ) '  For real single precision fast Fourier transforms, 1D,'
...
!
  ...
  lensav = 2 * ( l + m ) + int ( log ( real ( l, kind = 4 ) ) ) &
    + int ( log ( real ( m, kind = 4 ) ) ) + 8
...
!
  ...
  call sintmf ( lot, jump, n, inc, r, lenr, wsave, lensav, work, lenwrk, ier )
...
!  original data.
!
  call sintmb ( lot, jump, n, inc, r, lenr, wsave, lensav, work, lenwrk, ier )
...
!*****************************************************************************80
!
!! TEST16 tests ZFFT1B, ZFFT1F and ZFFT1I.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) '  ZFFT1I initializes the transform,'
  write ( *, '(a)' ) '  ZFFT1F does a forward transform;'
  write ( *, '(a)' ) '  ZFFT1B does a backward transform.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,i8)' ) '  The number of data items is N = ', n
!
!  Set work arrays.
...
!
  ...
  call zfft1f ( n, inc, c, lenc, wsave, lensav, work, lenwrk, ier )
...
!  original data.
!
  call zfft1b ( n, inc, c, lenc, wsave, lensav, work, lenwrk, ier )
...
!*****************************************************************************80
!
!! TEST17 tests ZFFT2B, ZFFT2F and ZFFT2I.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  call c8mat_print_some ( l, m, c, 1, 1, 5, 5, '  Part of the original data:' )
!
!  Compute the FFT coefficients.
!
  ldim = l
...
!  original data.
!
  call zfft2b ( ldim, l, m, c, wsave, lensav, work, lenwrk, ier )
...
!*****************************************************************************80
!
!! TEST18 tests ZFFTMB, ZFFTMF and ZFFTMI.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) '  ZFFTMI initializes the transform,'
  write ( *, '(a)' ) '  ZFFTMF does a forward transform;'
  write ( *, '(a)' ) '  ZFFTMB does a backward transform.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,i8)' ) '  The number of sequences is LOT =   ', lot
  write ( *, '(a,i8)' ) '  The length of each sequence is N = ', n
!
...
!
  ...
  call zfftmi ( n, wsave, lensav, ier )
!
!  Set the data values.
!
  seed = 1973
  ...
  call c8mat_print_some ( n, lot, c, 1, 1, 5, 5, '  Part of the original data:' )
!
!  Compute the FFT coefficients.
!
  jump = n
  ...
  call zfftmf ( lot, jump, n, inc, c, lenc, wsave, lensav, work, lenwrk, ier )
...
!  original data.
!
  call zfftmb ( lot, jump, n, inc, c, lenc, wsave, lensav, work, lenwrk, ier )
