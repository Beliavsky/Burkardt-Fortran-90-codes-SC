...
!*****************************************************************************80
!
!! MAIN is the main program for PIECEWISE_LINEAR_PRODUCT_INTEGRAL_TEST.
!
!  Discussion:
!
!    PIECEWISE_LINEAR_PRODUCT_INTEGRAL_TEST tests the
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'PIECEWISE_LINEAR_PRODUCT_INTEGRAL_TEST'
