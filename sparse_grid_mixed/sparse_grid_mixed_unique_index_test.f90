...
!****************************************************************************80
!
!! MAIN is the main program for SPARSE_GRID_MIXED_UNIQUE_INDEX_TEST.
!
!  Discussion:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SPARSE_GRID_MIXED_UNIQUE_INDEX_TEST'
  write ( *, '(a)' ) '  FORTRAN90 version'

  tol = r8_epsilon ( )
  call sparse_grid_mixed_unique_index_tests ( tol )
!
!  Terminate.
!
  write ( *, '(a)' ) ' '
...
subroutine sparse_grid_mixed_unique_index_tests ( tol )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SPARSE_GRID_MIXED_UNIQUE_INDEX_TESTS'
  write ( *, '(a)' ) '  Call SPARSE_GRID_MIXED_UNIQUE_INDEX_TEST with various arguments'
  ...
  call sparse_grid_mixed_unique_index_test ( dim_num, level_max_min, &
...
subroutine sparse_grid_mixed_unique_index_test ( dim_num, level_max_min, &
  level_max_max, rule, alpha, beta, tol )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SPARSE_GRID_MIXED_UNIQUE_INDEX_TEST'
  write ( *, '(a)' ) '  SPARSE_GRID_MIXED_UNIQUE_INDEX returns a mapping between'
  ...
  do dim = 1, dim_num
    if ( rule(dim) ==  1 ) then
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'SPARSE_GRID_MIXED_UNIQUE_INDEX_TEST - Fatal error!'
  ...
  do level_max = level_max_min, level_max_max
    ...
    call sparse_grid_mixed_unique_index ( dim_num, level_max, rule, &
