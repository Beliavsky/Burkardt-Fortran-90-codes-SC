...
!****************************************************************************80
!
!! MAIN is the main program for SPARSE_GRID_MIXED_POINT_TEST.
!
!  Discussion:
!
!    SPARSE_GRID_MIXED_POINT_TEST tests the SPARSE_GRID_MIXED_POINT routines.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SPARSE_GRID_MIXED_POINT_TEST'
  write ( *, '(a)' ) '  FORTRAN90 version'

  tol = r8_epsilon ( )
  call sparse_grid_mixed_point_tests ( tol )
!
!  Terminate.
!
  write ( *, '(a)' ) ' '
...
subroutine sparse_grid_mixed_point_tests ( tol )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SPARSE_GRID_MIXED_POINT_TESTS'
  write ( *, '(a)' ) '  Call SPARSE_GRID_MIXED_POINT_TEST with various arguments.'
  ...
  call sparse_grid_mixed_point_test ( dim_num, level_max_min, level_max_max, &
    rule, alpha, beta, tol )
  deallocate ( alpha )
  deallocate ( beta )
  deallocate ( rule )
...
subroutine sparse_grid_mixed_point_test ( dim_num, level_max_min, &
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SPARSE_GRID_MIXED_POINT_TEST'
  write ( *, '(a)' ) '  SPARSE_GRID_MIXED_POINT returns an array of the points'
  ...
  do dim = 1, dim_num
    if ( rule(dim) == 1 ) then
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'SPARSE_GRID_MIXED_POINT_TEST - Fatal error!'
