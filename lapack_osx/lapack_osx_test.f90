...
!*****************************************************************************80
!
!! MAIN is the main program for LAPACK_EXAMPLES_OSX_TEST.
!
!  Discussion:
!
!    LAPACK_EXAMPLES_OSX_TEST tests the OSX version of the LAPACK library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'LAPACK_EXAMPLES_OSX_TEST'
