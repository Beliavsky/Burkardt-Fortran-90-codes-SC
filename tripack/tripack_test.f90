...
!*****************************************************************************80
!
!! MAIN is the main program for TRIPACK_TEST.
!
!  Discussion:
!
!    TRIPACK_TEST tests the TRIPACK library.
!
...
!
  ...
  if ( n < 3 ) then
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'TRIPACK_TEST - Fatal error!'
...
!
  open ( unit = lplt, file = 'tripack_test.eps', status = 'replace' )
!
...
!
  title = '(Triangulation created by TRIPACK_TEST)'
