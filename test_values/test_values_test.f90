...
!*****************************************************************************80
!
!! MAIN is the main program for TEST_VALUES_TEST.
!
!  Discussion:
!
...
!
  ...
  do
    ...
    call jacobi_cn_values ( n_data, u, m, fx )
...
!
  ...
  do
    ...
    call jacobi_dn_values ( n_data, u, m, fx )
...
!
  ...
  do
    ...
    call jacobi_sn_values ( n_data, u, m, fx )
