...
!  Discussion:
!
!    G95_INTRINSICS_PRB calls some of the G95 intrinsic routines.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'G95_INTRINSICS'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the G95 intrinsic routines.'
...
!  Discussion:
!
!    RAND is the random number generator included in the G95 library.
!
