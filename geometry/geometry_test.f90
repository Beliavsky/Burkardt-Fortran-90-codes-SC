...
!
  ...
  call polygon_is_convex_2d_test ( )
...
!
  ...
  do test = 1, test_num
    ...
    theta = 2.0D+00 * r8_pi * real ( test     - 1, kind = 8 ) &
...
!
  ...
  do i = 1, 5
    call ball01_sample_nd ( dim_num, seed, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
...
!
  ...
  do i = - n_test, n_test
    ...
    h = real ( i, kind = 8 ) * r / real ( n_test, kind = 8 )
...
!
  ...
  real ( kind = 8 ) area
  real ( kind = 8 ), dimension(2) :: pc = (/ 0.0D+00, 0.0D+00 /)
  real ( kind = 8 ), parameter :: pi = 3.141592653589793D+00
...
!
  ...
  real ( kind = 8 ) h
  integer ( kind = 4 ) i
  integer ( kind = 4 ), parameter :: n_test = 6
...
!
  ...
  do i = 0, n_test
    ...
    angle = real ( i, kind = 8 ) * 2.0D+00 * r8_pi / real ( n_test, kind = 8 )
...
!
  ...
  do test = 0, test_num
    ...
    theta1 = 0.0D+00
    theta2 = real ( test, kind = 8 ) * 2.0D+00 * r8_pi &
           / real ( test_num, kind = 8 )
...
!*****************************************************************************80
!
!! TEST0125 tests SPHERE_CAP_VOLUME_2D.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  do i = 1, 10
    ...
    call r8vec_uniform_ab ( 2, -10.0D+00, +10.0D+00, seed, p )
...
!
  ...
  real ( kind = 8 ), dimension(2) :: pc1 = (/ 0.0D+00, 0.0D+00 /)
  real ( kind = 8 ) pc2(2)
  real ( kind = 8 ), parameter, dimension (2,test_num) :: &
    pc2_test = reshape ( (/ &
    5.0D+00,       5.0D+00, &
...
!
  ...
  do test = 0, test_num
    x = real ( test, kind = 8 ) * 2.0D+00 * r8_pi / real ( test_num, kind = 8 )
...
subroutine polygon_is_convex_2d_test ( )

!*****************************************************************************80
!
!! POLYGON_IS_CONVEX_2D_TEST tests POLYGON_IS_CONVEX_2D.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'POLYGON_IS_CONVEX_2D_TEST'
...
!*****************************************************************************80
!
!! TEST190 tests SPHERE01_SAMPLE_2D.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) '  SPHERE01_SAMPLE_2D samples;'
  ...
  do i = 1, 5
    call sphere01_sample_2d ( seed, x )
    write ( *, '(2x,2f8.4)' ) x(1:dim_num)
  end do
  ...
  do j = 1, 5
    ...
    call sphere01_sample_2d ( seed, v )
...
!*****************************************************************************80
!
!! TEST191 tests SPHERE01_SAMPLE_3D.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) '  SPHERE01_SAMPLE_3D samples;'
  ...
  do i = 1, 5
    call sphere01_sample_3d ( seed, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
  ...
  do j = 1, 5
    ...
    call sphere01_sample_3d ( seed, v )
...
!
  ...
  do i = 1, 5
    call sphere01_sample_3d_2 ( seed, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
  ...
  do j = 1, 5
    ...
    call sphere01_sample_3d_2 ( seed, v )
...
!
  ...
  do i = 1, 5
    call sphere01_sample_nd ( dim_num, seed, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
  ...
  do j = 1, 5
    ...
    call sphere01_sample_nd ( dim_num, seed, v )
...
!
  ...
  do i = 1, 5
    call sphere01_sample_nd_2 ( dim_num, seed, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
  ...
  do j = 1, 5
    ...
    call sphere01_sample_nd_2 ( dim_num, seed, v )
...
!
  ...
  do i = 1, 5
    call sphere01_sample_nd_3 ( dim_num, seed, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
  ...
  do j = 1, 5
    ...
    call sphere01_sample_nd_3 ( dim_num, seed, v )
