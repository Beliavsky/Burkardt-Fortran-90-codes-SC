...
!
      ...
      do
        ...
        call r8_gtle_range ( rho, rho_min, rho_max, ok )
      ...
      do
        ...
        call r8_gtle_range ( t, t_min, t_max, ok )
...
!
      ...
      do
        ...
        call r8_gtle_range ( p, p_min, p_max, ok )
...
!
      ...
      do
        ...
        call r8_gtle_range ( t, t_min, t_crit, ok )
...
!
      ...
      do
        ...
        call r8_gtle_range ( p, p_min, p_crit, ok )
...
subroutine r8_gtle_range ( x, a, b, ok )

!*****************************************************************************80
!
!! R8_GTLE_RANGE checks that A < X <= B.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
