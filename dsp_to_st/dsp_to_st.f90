...
!*****************************************************************************80
!
!! MAIN is the main program for DSP_TO_ST.
!
!  Discussion:
!
!    DSP_TO_ST converts a DSP sparse matrix file to ST format.
!
!    Each line of the DSP file has the form I, J, A(I,J).
!    The ST file uses the same format, but ST files use 0-based
...
!
  ...
  write ( *, '(a)' ) '  write the corresponding ST sparse matrix file.'
!
...
!
  ...
  call file_name_ext_swap ( output_filename, 'st' )
!
