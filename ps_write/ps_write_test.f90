...
!*****************************************************************************80
!
!! MAIN is the main program for PS_WRITE_TEST.
!
!  Discussion:
!
!    PS_WRITE_TEST tests the PS_WRITE library.
!
!  Licensing:
!
