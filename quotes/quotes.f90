...
!*****************************************************************************80
!
!! MAIN is the main program for QUOTES.
!
!  Discussion:
!
...
!
!  Linux laptop: /home/jburkardt/public_html/f_src/quotes/quote_files.txt
!
  if ( numarg == 0 ) then

    list_file_name = '/home/jburkardt/public_html/f_src/quotes/quote_files.txt'
    ...
    line_index = i4_uniform_ab ( 1, line_num, seed )
...
!
  quote_index = i4_uniform_ab ( 1, quote_num, seed )
