...
!  Parameters:
!
!    Input, real ( kind = 8 ) UMIN, VMIN, WMIN, UMAX, VMAX, WMAX, the (U,V,W) 
!    coordinates of the two opposite corners of the big box.
!
!    Input, real ( kind = 8 ) U, V, W, the (U,V,W) coordinates of a point in 
!    the big box.
!
...
!    coordinates of the two opposite corners of the big box.
!
!    Input, real ( kind = 8 ) U0, V0, W0, U1, V1, W1, the (U,V,W) coordinates 
!    of the two oppositie corners of the sub-box.
!
  implicit none
