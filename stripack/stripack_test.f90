...
!*****************************************************************************80
!
!! MAIN is the main program for STRIPACK_TEST.
!
!  Discussion:
!
!    STRIPACK_TEST is a test routine for STRIPACK.
!
!  Modified:
!
!    25 February 2007
...
!
  ...
  trplot_title = '(Triangulation created by STRIPACK_TEST)'
...
!
  ...
  vrplot_title = '(Voronoi diagram created by STRIPACK_TEST)'
