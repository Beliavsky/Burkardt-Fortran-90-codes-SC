...
!
  ...
  if ( numarg < 1 ) then
    ...
    if ( ierror /= 0 ) then
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TABLE_UNBORDER - Fatal error!'
...
!*****************************************************************************80
!
!! R8MAT_BORDER_CUT cuts the "border" of double precision table data.
!
!  Discussion:
!
