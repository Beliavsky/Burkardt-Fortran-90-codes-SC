...
!*****************************************************************************80
!
!! MAIN is the main program for CVT_SIZE_TEST.
!
!  Discussion:
!
!    CVT_SIZE_TEST tests the CVT_SIZE library.
!
!  Licensing:
!
...
!  Local Parameters:
!
!    Local, integer ( kind = 4 ) CELL_NUM, the number of generators to use.
!
!    Local, integer ( kind = 4 ) DIM_NUM, the spatial dimension (usually 2).
!
!    Local, integer ( kind = 4 ) PPMB_NCOL, the number of columns in the PPMB plots.
!
!    Local, integer ( kind = 4 ) PPMB_NROW, the number of rows in the PPMB plots.
!
...
!
  ...
  integer ( kind = 4 ), parameter :: cell_num = 10
  ...
  integer ( kind = 4 ), parameter :: centroid_it_max = 100
  integer ( kind = 4 ) i
  integer ( kind = 4 ) ios
