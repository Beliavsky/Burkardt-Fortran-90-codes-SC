...
!
  ...
  integer ( kind = 4 ) :: MaxListLength, ListLength
...
!
!  The user sees K, but we use eV internally.
!
  temp_requested = k_B * temp_requested              
