...
!*****************************************************************************80
!
!! MAIN is the main program for LAPACK_F77_TEST.
!
!  Discussion:
!
!    LAPACK_F77_TEST tests the FORTRAN77 version of theLAPACK library.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'LAPACK_F77_TEST'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the FORTRAN77 version of the LAPACK library.'
