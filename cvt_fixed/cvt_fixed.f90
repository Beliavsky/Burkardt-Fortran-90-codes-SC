...
!
!    Input, integer ( kind = 4 ) CELL_NUM, the number of Voronoi cells.
!
...
!    Input, integer ( kind = 4 ) DIM_NUM, the spatial dimension.
!
!    Input, integer ( kind = 4 ) CELL_NUM, the number of cell generatorrs.
!
...
!
!    Output, integer ( kind = 4 ) NGEN, the number of points that 
!    were generated.  This is at least 1, but may be larger if some points 
!    were rejected.
!
  integer ( kind = 4 ) dim_num
