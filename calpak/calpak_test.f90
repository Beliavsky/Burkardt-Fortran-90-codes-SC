...
!
  ...
  call ch_cap_test ( )
  call datenum_to_jed_test ( )
  call datenum_values_test ( )
  call day_list_common_test ( )
  call easter_gregorian_ds_test ( )
  call easter_gregorian_egr_test ( )
  call easter_gregorian_egr2_test ( )
  call easter_gregorian_knuth_test ( )
  call easter_gregorian_stewart_test ( )
  call easter_julian_egr_test ( )
  call easter_julian_egr2_test ( )
  call gps_to_jed_test ( )
  call i4_modp_test ( )
  call i4_normal_ab_test ( )
  call i4_uniform_ab_test ( )
  call i4_wrap_test ( )
  call jed_ce_values_test ( )
  call jed_is_legal_test ( )
  call jed_mjd_values_test ( )
  call jed_rd_values_test ( )
  call jed_to_datenum_test ( )
  call jed_to_gps_test ( )
  call jed_to_noon_nearest_test ( )
  call jed_to_noon_next_test ( )
  call jed_to_weekday_test ( )
!-------------------------------------------------------------------------------
  call jed_to_year_hebrew_test ( )
  call jed_weekday_values_test ( )
  call month_cal_common_test ( )
  call month_cal_english_test ( )
  call month_cal_gregorian_test ( )
  call month_cal_hebrew_test ( )
  call month_cal_islamic_a_test ( )
  call month_length_julian_test ( )
  call month_to_month_name_common_test ( )
  call month_to_month_name_common3_test ( )
  call month_to_month_name_greek_test ( )
  call nyt_to_jed_test ( )
  call r8_mod_test ( )
  call r8_uniform_01_test ( )
  call weekday_to_name_common_test ( )
  call weekday_to_name_common2_test ( )
  call weekday_to_name_common3_test ( )
  call weekday_to_name_islamic_test ( )
  call weekday_values_test ( )
  call y_to_s_common_test ( )
  call year_is_leap_english_test ( )
  call year_is_leap_greek_test ( )
  call year_length_days_common_test ( )
  call year_to_epact_gregorian_test ( )
  call year_to_epact_julian_test ( )
  call year_to_golden_number_test ( )
  call year_to_type_hebrew_test ( )
  call ymdf_to_week_common_test ( )
  call ymdf_to_weekday_hebrew_test ( )
  call ymdf_to_weekday_republican_test ( )
  call ymdhms_dif_dhms_test ( )
  call ymdhms_to_decimal_test ( )
...
!
  ...
  do i_test = 1, n_test
    ...
    days = year_length_days_coptic ( y )
...
!
  ...
  do i_test = 1, n_test
    ...
    days = year_length_days_eg_civil ( y )
...
!*****************************************************************************80
!
!! TEST337 tests MONTH_LENGTH_EG_LUNAR.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  do i_test = 1, n_test
    ...
    days = year_length_days_eg_lunar ( y )
...
!
  ...
  do i_test = 1, n_test
    ...
    days = year_length_days_ethiopian ( y )
...
!
  ...
  do i_test = 1, n_test
    ...
    days = year_length_days_persian ( y )
...
!*****************************************************************************80
!
!! TEST58 tests YEAR_LENGTH_DAYS_ENGLISH.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST58'
  write ( *, '(a)' ) '  For the English calendar:'
  write ( *, '(a)' ) '  YEAR_LENGTH_DAYS_ENGLISH determines the length of a year.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Year  Length'
  write ( *, '(a)' ) ' '
  ...
  do y = 1580, 1585
    call y_to_s_english ( y, sy )
    write ( *, '(2x,a,2x,i6)' ) sy, year_length_days_english ( y )
  end do
...
!*****************************************************************************80
!
!! TEST585 tests YEAR_LENGTH_DAYS_GREEK.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST585'
  write ( *, '(a)' ) '  For the Greek calendar:'
  write ( *, '(a)' ) '  YEAR_LENGTH_DAYS_GREEK determines the length of a year.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Year  Length'
  write ( *, '(a)' ) ' '
  ...
  do y = 1, 10
    call y_to_s_greek ( y, sy )
    write ( *, '(2x,a,2x,i6)' ) sy, year_length_days_greek ( y )
  end do
...
!*****************************************************************************80
!
!! TEST59 tests YEAR_LENGTH_DAYS_GREGORIAN.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST59'
  write ( *, '(a)' ) '  For the Gregorian calendar:'
  write ( *, '(a)' ) '  YEAR_LENGTH_DAYS_GREGORIAN determines the length of a year.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Year  Length'
  write ( *, '(a)' ) ' '
  ...
  do y = 1580, 1585
    call y_to_s_gregorian ( y, sy )
    write ( *, '(2x,a,2x,i8)' ) sy, year_length_days_gregorian ( y )
  end do
...
!*****************************************************************************80
!
!! TEST60 tests YEAR_LENGTH_DAYS_HEBREW.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST60'
  write ( *, '(a)' ) '  For the Hebrew calendar,'
  write ( *, '(a)' ) '  YEAR_LENGTH_DAYS_HEBREW determines the length of a year.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Year  Length'
  write ( *, '(a)' ) ' '
  ...
  do y = 5760, 5780
    call y_to_s_hebrew ( y, sy )
    write ( *, '(2x,a,2x,i6)' ) trim ( sy ), year_length_days_hebrew ( y )
  end do
...
!*****************************************************************************80
!
!! TEST605 tests YEAR_LENGTH_DAYS_ISLAMIC.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST605'
  write ( *, '(a)' ) '  For the Islamic calendar:'
  write ( *, '(a)' ) '  YEAR_LENGTH_DAYS_ISLAMIC determines the length of a year.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Year  Length'
  write ( *, '(a)' ) ' '
  ...
  do y = 500, 505
    call y_to_s_islamic ( y, sy )
    write ( *, '(2x,a,2x,i6)' ) trim ( sy ), year_length_days_islamic ( y )
  end do
...
!*****************************************************************************80
!
!! TEST61 tests YEAR_LENGTH_DAYS_JULIAN.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST61'
  write ( *, '(a)' ) '  For the Julian calendar:'
  write ( *, '(a)' ) '  YEAR_LENGTH_DAYS_JULIAN determines the length of a year.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Year  Length'
  write ( *, '(a)' ) ' '
  ...
  do y = 1580, 1585
    call y_to_s_julian ( y, sy )
    write ( *, '(2x,a,2x,i6)' ) sy, year_length_days_julian ( y )
  end do
...
!*****************************************************************************80
!
!! TEST615 tests YEAR_LENGTH_DAYS_REPUBLICAN.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST615'
  write ( *, '(a)' ) '  For the Republican calendar:'
  write ( *, '(a)' ) '  YEAR_LENGTH_DAYS_REPUBLICAN determines the length of a year.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Year  Length'
  write ( *, '(a)' ) ' '
  ...
  do y = 1, 6
    call y_to_s_republican ( y, sy )
    write ( *, '(2x,a,2x,i6)' ) sy, year_length_days_republican ( y )
  end do
...
!*****************************************************************************80
!
!! TEST616 tests YEAR_LENGTH_DAYS_ROMAN.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST616'
  write ( *, '(a)' ) '  For the Roman calendar:'
  write ( *, '(a)' ) '  YEAR_LENGTH_DAYS_ROMAN determines the length of a year.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Year  Length'
  write ( *, '(a)' ) ' '
  ...
  do y = 96, 100
    call y_to_s_roman ( y, sy )
    write ( *, '(2x,a,2x,i6)' ) sy, year_length_days_roman ( y )
  end do
